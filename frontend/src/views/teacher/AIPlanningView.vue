              ...
              >
                ...
                <el-form-item label="教学重点">
                  <el-checkbox-group v-model="planForm.focus">
                    <el-checkbox label="speaking">
                      口语
                    </el-checkbox>
                    <el-checkbox label="listening">
                      听力
                    </el-checkbox>
                    <el-checkbox label="reading">
                      阅读
                    </el-checkbox>
                    <el-checkbox label="writing">
                      写作
                    </el-checkbox>
              ...
              >
                ...
                >
                  ...
                  <el-descriptions-item label="时长">
                    {{ generatedPlan.duration }} 分钟
                  </el-descriptions-item>
                  <el-descriptions-item label="ID">
                    {{ generatedPlan.id?.slice(0, 8) }}...
                  </el-descriptions-item>
                </el-descriptions>
                ...
                <div v-if="generatedPlan.objectives">
                  <div
                    v-if="generatedPlan.objectives.language_knowledge"
                    class="mb-2"
                  >
                    <strong>语言知识：</strong>
                    <ul class="inline-list">
                      <li
                        v-for="(obj, i) in generatedPlan.objectives.language_knowledge"
                        :key="i"
                      >
                        {{ obj }}
                      </li>
                  ...
                  <div
                    v-if="generatedPlan.objectives.language_skills"
                    class="mb-2"
                  >
                    <strong>语言技能：</strong>
                    <div
                      v-for="item in languageSkillsList"
                      :key="item.type"
                      class="ml-3"
                    >
                      ...
                      <span
                        ...
                        :key="i"
                      >{{ skill }}{{ i < item.skills.length - 1 ? '、' : '' }}</span>
                    </div>
                  </div>
                </div>
                ...
                <div
                  v-if="generatedPlan.vocabulary?.noun?.length"
                  class="vocab-list"
                >
                  <el-tag
